...
public class CodeReq {
    ...
    @Schema(description = "코드 내용을 담은 github URL", example = "https://api.github.com/repos/cody/hello-world/contents/src/main.py?ref=594e05aee256df9e4e826ff56ea2a8c38e9e7972")
